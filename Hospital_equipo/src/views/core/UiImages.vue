        ...
        <iq-card>
          ...
          <template v-slot:body>
            <p>
              ...
              <code>.img-fluid</code>. <code>max-width: 100%;</code> and <code>height: auto;</code> are applied to the image so that it scales with the parent element.
            </p>
...
&lt;/b-media&gt;
            ...
            <b-media right-align class="mb-5 d-flex">
              <!-- <template v-slot:aside> -->
              <b-img :src="require('../../assets/images/page-img/18.jpg')" alt="#" class="avatar-80 me-3 order-2"></b-img>
              <!-- </template> -->
              <b-media-body>
                <h5 class="mt-0 mb-1">Top-aligned media</h5>
                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
            ...
            <b-media right-align vertical-align="center" class="mb-5 d-flex">
              <!-- <template v-slot:aside> -->
              <b-img :src="require('../../assets/images/page-img/19.jpg')" alt="#" class="me-3 avatar-80 order-2 align-self-center"></b-img>
              <!-- </template> -->
              <b-media-body>
                <h5 class="mt-0 mb-1">Center-aligned media</h5>
                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
            ...
            <b-media right-align vertical-align="end" class="d-flex">
              <!-- <template v-slot:aside> -->
              <b-img :src="require('../../assets/images/page-img/20.jpg')" alt="#" class="avatar-80 me-3 order-2 align-self-end"></b-img>
              <!-- </template> -->
              <b-media-body>
                <h5 class="mt-0 mb-1">Bottom-aligned media</h5>
                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
      ...
      <b-col lg="6" sm="12">
        <iq-card>
          ...
          <template v-slot:body>
            <p>
              In addition to our
              <a href="/docs/4.3/utilities/borders/">border-radius utilities</a>, you can use <code>.img-thumbnail</code> to give an image a rounded 1px border appearance.
            </p>
...
&lt;b-img rounded="circle" :src="require('../../assets/images/page-img/12.jpg')" alt="Responsive image"&gt;&lt;/b-img&gt;
            ...
            <b-img thumbnail :src="require('../../assets/images/page-img/10.jpg')" alt="Responsive image"></b-img>
            <b-img rounded class="ms-3" :src="require('../../assets/images/page-img/11.jpg')" alt="Responsive image"></b-img>
            <b-img rounded="circle ms-3" :src="require('../../assets/images/page-img/12.jpg')" alt="Responsive image"></b-img>
          </template>
        </iq-card>
        <iq-card>
          <template v-slot:headerTitle>
...
&lt;/b-media&gt;
            ...
            <b-media class="mb-4 d-flex">
              <!-- <template v-slot:aside> -->
              <b-img :src="require('../../assets/images/page-img/21.jpg')" alt="#" class="me-3 avatar-80 align-self-top"></b-img>
              <!-- </template> -->
              <b-media-body>
                <h5 class="mt-0">Top-aligned media</h5>
                <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
            ...
            <b-media vertical-align="center" class="mb-4 d-flex">
              <!-- <template v-slot:aside> -->
              <b-img :src="require('../../assets/images/page-img/22.jpg')" alt="#" class="me-3 avatar-80 align-self-center"></b-img>
              <!-- </template> -->
              <b-media-body>
                <h5 class="mt-0 mb-1">Center-aligned media</h5>
                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
            ...
            <b-media vertical-align="end" class="d-flex">
              <!-- <template v-slot:aside> -->
              <b-img :src="require('../../assets/images/page-img/23.jpg')" alt="#" class="me-3 avatar-80 align-self-end"></b-img>
              <!-- </template> -->
              <b-media-body>
...
&lt;/ul&gt;
            ...
            <ul class="list-unstyled">
              ...
              <b-media tag="li" class="d-flex">
                <!-- <template v-slot:aside> -->
                <b-img :src="require('../../assets/images/page-img/16.jpg')" alt="#" class="me-3 avatar-80"></b-img>
                <!-- </template> -->
                <b-media-body>
                  <h5 class="mt-0 mb-1">List-based media object</h5>
                  Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
