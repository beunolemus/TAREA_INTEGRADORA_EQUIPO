          ...
          <template v-slot:body>
            <div class="docter-details-block">
              ...
              <ul class="doctoe-sedual d-flex align-items-center justify-content-between p-0 m-0">
                ...
                <li class="text-center">
                  <h3 class="mb-0 line-height">
                    <span><count-up :end-val="100" duration="5"></count-up></span>
                  </h3>
                  <span>Hospital</span>
                </li>
                <li class="text-center">
                  <h3 class="mb-0 line-height">
                    <span><count-up :end-val="10000" duration="5"></count-up></span>
                  </h3>
                  <span>Patients</span>
                </li>
              </ul>
            ...
            <div class="iq-card-body">
              <ul class="profile-img-gallary d-flex flex-wrap p-0 m-0">
                <li class="col-md-4 col-6 pb-3">
                  <a href="javascript:void(0);"><img src="../../assets/images/page-img/g1.jpg" alt="gallary-image" class="img-fluid" /></a>
                </li>
                <li class="col-md-4 col-6 pb-3">
                  <a href="javascript:void(0);"><img src="../../assets/images/page-img/g2.jpg" alt="gallary-image" class="img-fluid" /></a>
                </li>
                <li class="col-md-4 col-6 pb-3">
                  <a href="javascript:void(0);"><img src="../../assets/images/page-img/g3.jpg" alt="gallary-image" class="img-fluid" /></a>
                </li>
                <li class="col-md-4 col-6 pb-3">
                  <a href="javascript:void(0);"><img src="../../assets/images/page-img/g4.jpg" alt="gallary-image" class="img-fluid" /></a>
                </li>
                <li class="col-md-4 col-6 pb-3">
                  <a href="javascript:void(0);"><img src="../../assets/images/page-img/g5.jpg" alt="gallary-image" class="img-fluid" /></a>
                </li>
                <li class="col-md-4 col-6 pb-3">
                  <a href="javascript:void(0);"><img src="../../assets/images/page-img/g6.jpg" alt="gallary-image" class="img-fluid" /></a>
                </li>
                <li class="col-md-4 col-6 pb-0">
                  <a href="javascript:void(0);"><img src="../../assets/images/page-img/g7.jpg" alt="gallary-image" class="img-fluid" /></a>
                </li>
                <li class="col-md-4 col-6 pb-0">
                  <a href="javascript:void(0);"><img src="../../assets/images/page-img/g8.jpg" alt="gallary-image" class="img-fluid" /></a>
                </li>
                <li class="col-md-4 col-6 pb-0">
                  <a href="javascript:void(0);"><img src="../../assets/images/page-img/g9.jpg" alt="gallary-image" class="img-fluid" /></a>
                </li>
              </ul>
            </div>
          </template>
                ...
                <ul class="speciality-list m-0 p-0">
                  <li class="d-flex mb-4 align-items-center">
                    <div class="user-img img-fluid">
                      <a href="#" class="iq-bg-primary"><i class="ri-award-fill"></i></a>
                    </div>
                  ...
                  <li class="d-flex mb-4 align-items-center">
                    <div class="user-img img-fluid">
                      <a href="#" class="iq-bg-warning"><i class="ri-award-fill"></i></a>
                    </div>
                    <div class="media-support-info ms-3">
                      <h6>Certified</h6>
            ...
            <iq-card>
              ...
              <template v-slot:body>
                <ul class="list-inline m-0 p-0">
                  <li>
                    <h6 class="float-start mb-1">Ruby saul (Blood Check)</h6>
                  ...
                  <li>
                    <h6 class="float-start mb-1">Anna Sthesia (Full body Check up)</h6>
                    <small class="float-end mt-1">Today</small>
                    <div class="d-inline-block w-100">
